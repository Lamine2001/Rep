...
/**
 * <p>
 * Das {@code BaItem2ResourceAssignmentMapping} mappt die Felder des
 * {@link AvBaItem} auf das dazugehoerige {@code ResourceAssignment}
 * </p>
 */
public class BaItem2ResourceAssignmentMapping implements Mapping<AvBaItem, ResourceAssignment> {

    private static final Logger LOG = Logger.getLogger(BaItem2ResourceAssignmentMapping.class);
    ...
    protected void mapUnit(final AvBaItem inputObject, final ResourceAssignment outputObject) {
        ...
        try {
            ...
            if (null != inputObject.getUnits()) {
                outputObject.setActualUnits(new Unit(inputObject.getUnits()));
            }
