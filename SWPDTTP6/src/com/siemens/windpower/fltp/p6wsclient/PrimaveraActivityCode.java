...
public class PrimaveraActivityCode {
	...
	PrimaveraActivityCode() throws Exception {
		activitymasterbean = new ActivityMasterBean();
		if (servicePort == null || activitycodeassignmentserviceport == null) {
	...
	List<ActivityCode> readActivityCode() throws Exception {
	...
	List<ActivityCode> readActivityCodes(String activityobjectid)
			throws Exception {
	...
	List createActivityCode(List<ActivityCode> activitycodes) throws Exception {
	...
	List createActivityCodeAssignment(List<ActivityCodeAssignment> activitysudf)
			throws Exception {
		...
		List<ObjectId> objIds = activitycodeassignmentserviceport
				.createActivityCodeAssignments(activitysudf);
		System.out
				.println(objIds.size() + " Activity Code Assignment Created:");
